...
1. [`CONTRIBUTING.md`](https://github.com/Samsung/tizen-docs/blob/master/CONTRIBUTING.md), the
   [`styleguide/`](https://github.com/Samsung/tizen-docs/tree/master/styleguide) documents, and the
   [`reviewguide/`](https://github.com/Samsung/tizen-docs/tree/master/reviewguide) documents
...
[`reviewguide/`](https://github.com/Samsung/tizen-docs/tree/master/reviewguide) before approving:

- [`review_points_guide.md`](https://github.com/Samsung/tizen-docs/blob/master/reviewguide/review_points_guide.md) — general guide
  pages: branches, headings, adding/renaming/moving/deleting a page, tags
- [`review_points_web_api.md`](https://github.com/Samsung/tizen-docs/blob/master/reviewguide/review_points_web_api.md) — required
...
- [`review_points_release_note.md`](https://github.com/Samsung/tizen-docs/blob/master/reviewguide/review_points_release_note.md) —
  release-note conventions (release date, tone, TOC registration) for Tizen Studio and
  Tizen Platform notes
- [`stg_build.md`](https://github.com/Samsung/tizen-docs/blob/master/reviewguide/stg_build.md) — use the Jenkins-built staging URL
  attached to the PR to check rendered output before approving
- [`update_docs_tizen_org.md`](https://github.com/Samsung/tizen-docs/blob/master/reviewguide/update_docs_tizen_org.md) — how an
