...
3. **Prose by default.** Write flowing paragraphs. Use a list only for truly discrete items or when asked; then each bullet is 1–2 full sentences, not a bolded fragment. Never the "**Bold term:** explanation" pattern.
