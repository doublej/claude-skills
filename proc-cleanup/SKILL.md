...
<scripts>
All scripts are in `~/.claude/skills/proc-cleanup/scripts/`.

### Scan

```bash
bash ~/.claude/skills/proc-cleanup/scripts/scan.sh           # overview
bash ~/.claude/skills/proc-cleanup/scripts/scan.sh --ports    # include port listeners
bash ~/.claude/skills/proc-cleanup/scripts/scan.sh --json     # structured output
```
...
```bash
bash ~/.claude/skills/proc-cleanup/scripts/kill.sh <pid> [pid...]        # SIGTERM → SIGKILL
bash ~/.claude/skills/proc-cleanup/scripts/kill.sh --force <pid> [pid...]  # immediate SIGKILL
```

### Kill by Category

```bash
bash ~/.claude/skills/proc-cleanup/scripts/kill-category.sh claude        # all Claude Code procs
bash ~/.claude/skills/proc-cleanup/scripts/kill-category.sh mcp           # all MCP servers
bash ~/.claude/skills/proc-cleanup/scripts/kill-category.sh dev           # all dev servers
bash ~/.claude/skills/proc-cleanup/scripts/kill-category.sh port:3000     # everything on port 3000
```
