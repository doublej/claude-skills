---
name: pixijs-perf
description: Analyze PixiJS code for performance issues and suggest optimizations. Use when reviewing PixiJS applications for bottlenecks, memory leaks, or rendering inefficiencies.
---
